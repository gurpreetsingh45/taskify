...
export const registerSchema = z.object({
    name: z.string().min(2, "name must be of atleast 2 characters").max(50, "name should not be more than 50 charactrs"),
...
}).refine((data) => data.password === data.confirmPassword, {message : "Both the passwords dont match", path: ["confirmPassword"]})
